namespace Fundamentos
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            float temperatura = 27.43f;                 //Pode ser usado tanto f ou F
            ...
            const int valorReceber = 644;
            //valorReceber = 888;

            //não podemos alterar o valor de uma constante, o compilador vai indicar um erro
