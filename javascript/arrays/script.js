...
const r1 = nomes.pop(); //Ultimo
const r2 = nomes.shift(); //Primeiro
...
alturas.push(1.75); //Ultimo
alturas.unshift(1.58); //Primeiro
...
letras.splice(2, 3, "X", "Y"); //(Index inicial, tamanho, adicionar...)
...
// PERCORRER ARRAY COM FORIN

console.log("Teste percorrer array com forIn");
